...
- In mobile & ipad version, the navigation each section is invisible. (check)
- After the hero section, make the 20+Shows Played, 98%Repeat Bookings, 10+Years Performing in one horizontal line (mobile). 
- After the hero section, make the 20+Shows Played, 98%Repeat Bookings, 10+Years Performing move to the center (ipad mini & air). (centered)
- 
